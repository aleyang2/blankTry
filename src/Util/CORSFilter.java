...
//    }
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        if (filterConfig != null) {
            ...
            log("CORSFilter: Allowed Origins=" + configAllowedOrigins);
        }
    }
    ...
    public CORSRequestType checkRequestType(final HttpServletRequest request) {
        ...
        if (originHeader != null) {
            ...
            } else if (originHeader.equalsIgnoreCase("null")) {
                // Prasad: Consider "null literal string" originHeader, as a null header: different from original ebay implementation.
                requestType = CORSRequestType.NOT_CORS;
            } else if (!isValidOrigin(originHeader)) {
                requestType = CORSRequestType.INVALID_CORS;
                log("Setting type to INVALID_CORS, origin is invalid, origin="+originHeader);
            } else {
                String method = request.getMethod();
                    ...
                    if ("OPTIONS".equals(method)) {
                        ...
                        if (accessControlRequestMethodHeader != null
                            ...
                            requestType = CORSRequestType.PRE_FLIGHT;
                                ...
                                && accessControlRequestMethodHeader.isEmpty()) {
                            requestType = CORSRequestType.INVALID_CORS;
                            log("Setting type to INVALID_CORS, method=OPTIONS, origin="+originHeader);
                        } else {
